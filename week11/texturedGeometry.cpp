...
osg::Geode* createPyramid()
{
   ...
   colors->push_back(osg::Vec4(0.0f, 1.0f, 1.0f, 1.0f) ); //index 1 green
   ...
   // pyramidGeometry->setColorIndices(colorIndexArray); // depracated
  ...
  osg::Vec2Array* texcoords = new osg::Vec2Array(5);
   (*texcoords)[0].set(0.75f,0.0f); // tex coord for vertex 0 
   (*texcoords)[1].set(0.50f,0.0f); // tex coord for vertex 1 
...
int main()
{
   ...
   // ensure that KLN89FaceB.tga is in curr dir.
